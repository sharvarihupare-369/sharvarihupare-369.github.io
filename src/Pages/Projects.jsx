        ...
        >
          ...
          >
            ...
            >
              <Flex justifyContent={"space-between"}>
                ...
                <Box>
                  <Flex>
                    <Link
                      target="_blank"
                      href="https://github.com/sharvarihupare-369/dashDonation-charityapplication-"
                    ...
                    <Link
                      target="_blank"
                      href="https://dash-donation-three.vercel.app/"
              ...
              >
                Dash Donation(Charity Hero Clone)
              </Heading>
              <Text
                ...
                mt="10px"
              >
                Dash Donation is a charitable (Non profitable organization)
                website which provides food, medicines, education and relief for
                victims of Ukraine war. It runs with the help of many partner
                organizations which work together.
              </Text>
          ...
          >
            ...
            >
              <Flex justifyContent={"space-between"}>
                ...
                <Box>
                  <Flex>
                    <Link
                      target="_blank"
                      href="https://github.com/sharvarihupare-369/fullStacktodoApp"
                      className="project-github-link"
                    >
                      <FaGithub style={{ fontSize: "40px" }} />
                    </Link>
                    <Link
                      target="_blank"
                      href="https://todomanager-five.vercel.app/"
                      className="project-deployed-link"
                    >
                      {" "}
                      <BiCopy style={{ fontSize: "40px", marginLeft: "5px" }} />
              ...
              <Text
                ...
                mt="10px"
              >
                TodoManager is a powerful and user-friendly Todo Application
                designed to streamline task management and boost your
                productivity.
              </Text>
              <Text textAlign={"left"}>
                On the front-end, I harness the power of React.js, Redux.js, and
                TypeScript for a dynamic and responsive user interface.
              </Text>
              <Text textAlign={"left"}>
                For back-end I used Node.js and Express.js, ensuring robust
                server-side functionality.
              </Text>
              <Text textAlign={"left"}>
                MongoDB serves as database of choice, enabling seamless data
                management.
              </Text>
              ...
              <Box w={"100%"} mt="30px" className="project-tech-stack">
                <Flex w={"100%"} justifyContent={"space-between"}>
                  ...
                  <Text>
                    <SiTypescript
                      style={{ fontSize: "40px", color: "#2e6ff2" }}
                    />
                  </Text>
                  <Text>
                    <FaNodeJs style={{ fontSize: "40px", color: "#539e43" }} />
                  </Text>
                  <Text>
                    <SiMongodb style={{ fontSize: "40px", color: "#4caa3d" }} />
                  </Text>
          ...
          >
            ...
            >
              <Flex justifyContent={"space-between"}>
                ...
                <Box>
                  <Flex>
                    ...
                    <Link
                      target="_blank"
                      href="https://mediverse-five.vercel.app/"
                      className="project-deployed-link"
                    >
                      {" "}
                      <BiCopy style={{ fontSize: "40px", marginLeft: "5px" }} />
              ...
              <Text
                ...
                mt="10px"
              >
                An online booking appointment website where user or patient can
                book their appointment digitally with the doctor they want to
                visit.
              </Text>
              ...
              <Flex justifyContent={"space-between"}>
                ...
                <Box>
                  <Flex>
                    <Link
                      target="_blank"
                      href="https://github.com/Upendrapal0607/satisfying-scale-7625"
                      className="project-github-link"
                    >
                      <FaGithub style={{ fontSize: "40px" }} />
                    </Link>
                    <Link
                      target="_blank"
                      href="https://timely-paprenjak-287908.netlify.app/"
                      className="project-deployed-link"
                    >
                      {" "}
                      <BiCopy style={{ fontSize: "40px", marginLeft: "5px" }} />
          ...
          >
            ...
            >
              <Flex justifyContent={"space-between"}>
                ...
                <Box>
                  <Flex>
                    <Link
                      target="_blank"
                      href="https://github.com/sharvarihupare-369/adorable_crownn-8253"
                      className="project-github-link"
                    >
                      <FaGithub style={{ fontSize: "40px" }} />
                    </Link>
                    <Link
                      target="_blank"
                      href="https://gem-garden.vercel.app/"
                      className="project-deployed-link"
                    >
                      {" "}
                      <BiCopy style={{ fontSize: "40px", marginLeft: "5px" }} />
              ...
              <Text
                ...
                mt="10px"
              >
                A Jewelery website which sells online jewellery of different
                types.
              </Text>
